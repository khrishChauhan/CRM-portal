        ...
        <div className="mx-4 md:mx-6 my-3 md:my-4 p-4 md:p-6 bg-white border border-gray-100 border-l-[3px] border-l-blue-600 rounded-2xl cursor-default group hover:shadow-sm transition-shadow">
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 md:gap-6">
                <div className="flex items-start sm:items-center gap-4 md:gap-6">
                    ...
                    <div>
                        <p className="text-[14px] md:text-[15px] font-bold text-[#1A1A1A] leading-snug md:leading-tight pr-2">
                            {log.message}
                        </p>
                        <div className="flex flex-wrap items-center gap-3 md:gap-4 mt-2">
                            <span className={`px-2 md:px-3 py-0.5 rounded-lg border text-[8px] md:text-[9px] font-bold uppercase tracking-widest ${roleColors[log.actorRole] || 'bg-gray-50 text-gray-400 border-gray-100'}`}>
                                {log.actorRole}
                            </span>
                            <div className="w-1 h-1 md:w-1.5 md:h-1.5 bg-gray-200 rounded-full"></div>
                            <span className="text-[9px] md:text-[10px] font-bold text-gray-400 flex items-center gap-1.5 md:gap-2 uppercase tracking-widest">
